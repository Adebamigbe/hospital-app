...
class SpecialisationsControllerTest < ActionController::TestCase
  ...
  test "should create specialisation" do
    assert_difference('Specialisation.count') do
      post :create, specialisation: { name: @specialisation.name, spec_cat_id: @specialisation.spec_cat_id, specialisation_id: @specialisation.specialisation_id }
    end
  ...
  test "should update specialisation" do
    put :update, id: @specialisation, specialisation: { name: @specialisation.name, spec_cat_id: @specialisation.spec_cat_id, specialisation_id: @specialisation.specialisation_id }
    assert_redirected_to specialisation_path(assigns(:specialisation))
  end
