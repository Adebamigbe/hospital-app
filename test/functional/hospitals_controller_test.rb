...
class HospitalsControllerTest < ActionController::TestCase
  ...
  test "should create hospital" do
    assert_difference('Hospital.count') do
      post :create, hospital: { address: @hospital.address, name: @hospital.name, telephone: @hospital.telephone }
    end
  ...
  test "should update hospital" do
    put :update, id: @hospital, hospital: { address: @hospital.address, name: @hospital.name, telephone: @hospital.telephone }
    assert_redirected_to hospital_path(assigns(:hospital))
  end
